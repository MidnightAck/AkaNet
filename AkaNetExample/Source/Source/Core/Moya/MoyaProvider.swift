...
public protocol MoyaProviderType: AnyObject {
    ...
    func request(_ target: Target, priority: RequestPriority, callbackQueue: DispatchQueue?, progress: ProgressBlock?, completion: @escaping Completion) -> MoyaCancellable
}
